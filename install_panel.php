...
function GetFos() {
    ...
    shell_exec("git clone https://github.com/Joinwit/IPTV-MD.git /usr/src/FOS-Streaming/ > /dev/null");
...
function GetFOSResources($arch) {
    ...
    shell_exec("wget https://sourceforge.net/projects/iptv-md/files/ionix/{$fos} -O /home/fos-streaming/{$fos} > /dev/null");
